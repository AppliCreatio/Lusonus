...
1. Download the latest Android Studio app.
2. Clone the repository into Android Studio.
3. Sync and Build the appliction if Android Studio has not done it for you.
4. Run the applicatin using the arrow button at the top of the application.
5. Have a nice time using the application :)

## Screenshots of application
- (by Sprint 1): Screenshots from each of the main screens of your application.
  <img width="289" height="652" alt="image" src="https://github.com/user-attachments/assets/0d2128da-7559-4db2-97f0-8d1734827ab7" />
  <img width="294" height="645" alt="image" src="https://github.com/user-attachments/assets/ac9c4074-694e-4c2d-be22-9cf5d877eec0" />
  <img width="288" height="649" alt="image" src="https://github.com/user-attachments/assets/e31f7cb4-d0b6-4597-8c0a-33e109ba5e22" />
